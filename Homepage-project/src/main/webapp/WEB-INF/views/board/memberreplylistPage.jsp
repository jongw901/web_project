		...
		<section id="container">
			<form role="form" method="get">
				<table class="type">
					...
					<c:forEach items="${memberreplylistPage}" var="memberreplylistPage">
						<tr>
							<td>
							<a href="/board/readView?userId=${scri.userId}&
															bno=${memberreplylistPage.bno}&
															page=${scri.page}&
															perPageNum=${scri.perPageNum}&
															searchType=${scri.searchType}&
															keyword=${scri.keyword}"><c:out value="${memberreplylistPage.content}" /></a></td>
							<td><c:out value="${memberreplylistPage.writer}" /></td>
						</tr>
					</c:forEach>
				</table>
				<hr />
